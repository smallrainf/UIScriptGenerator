...
namespace UIScript
{
    public class UIScriptGenerator : Editor
    {
        ...
        {
            GenerateCSharpScript(Application.dataPath + "/UIScriptGenerator/Editor/Template/CSharp.txt", true);
        }

        [MenuItem("GameObject/UIScript/创建CSharpSubScreen脚本", false, 1)]
        public static void GenerateCSharpItemScript()
        {
            GenerateCSharpScript(Application.dataPath + "/UIScriptGenerator/Editor/Template/CSharpItem.txt", false);
        }
        ...
        {
            GenerateLuaScript(Application.dataPath + "/UIScriptGenerator/Editor/Template/Lua.txt", true);
        }

        [MenuItem("GameObject/UIScript/创建LuaSubScreen脚本", false, 2)]
        public static void GenerateLuaItemScript()
        {
            GenerateLuaScript(Application.dataPath + "/UIScriptGenerator/Editor/Template/LuaItem.txt", false);
        }
